...
#
# Refactored into functions for maintainability and testability.
#
...
scaffold_ralph_files() {
    ...
    echo "  $(green 'OK') ralph-runs directory created with restricted permissions (700)"
